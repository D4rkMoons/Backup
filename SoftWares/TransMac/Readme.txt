...
v14.6
CHANGES:
- Support encrypted disk images (dmg and sparseimages) in full version.
- Fixed rare fault opening APFS volumes

v14.5
CHANGES:
- Fixed problem reading some partition maps
- Fixed APFS problem reading some files
...
- Fixed incorrect file size problem

v14.2
CHANGES:
- APFS multiple partition support
- Faster restoring/expanding dmg files
- Fixed problem opening some dmg files
- Fixed fault on exit issues
- Fixed write error when creating dmg
- UI changes
